...
| [ceph-csi-drivers](charts/ceph-csi-drivers) | [GitHub](https://github.com/ceph/ceph-csi-operator/tree/main/deploy/charts/ceph-csi-drivers) | Renovate | [ceph-csi-drivers](https://github.com/users/linuzctl/packages/container/package/helm-charts/ceph-csi-drivers) |
| [ceph-csi-operator](charts/ceph-csi-operator) | [GitHub](https://github.com/ceph/ceph-csi-operator/tree/main/deploy/charts/ceph-csi-operator) | Renovate | [ceph-csi-operator](https://github.com/users/linuzctl/packages/container/package/helm-charts/ceph-csi-operator) |
...
| [gitlab-operator](charts/gitlab-operator) | [GitLab](https://gitlab.com/gitlab-org/cloud-native/gitlab-operator/-/tree/master/deploy/chart) | Renovate | [gitlab-operator](https://github.com/users/linuzctl/packages/container/package/helm-charts/gitlab-operator) |
